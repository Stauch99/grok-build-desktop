...
export function packAppModel(p: PackAppModelInput) {
  ...
  return {
    ...
    requestRemoveProject: ws.requestRemoveProject,
    ...
    devinAuthStatus: acp.devinAuthStatus,
    devinAuthError: acp.devinAuthError,
    authenticateDevin: acp.authenticateDevin,
    dismissDevinAuth: acp.dismissDevinAuth,
    ...
    leavingPanes: ws.leavingPanes,
    leavingSessions: ws.leavingSessions,
    freshSessions: ws.freshSessions,
    ...
    setComposerDraft: acp.setComposerDraft,
    ...
    panePendingExtra: view.panePendingExtra,
    ...
    onFoundingNow: dream.onFoundingNow,
    foundingAt: dream.foundingAt,
    dreamProposals: dream.skillProposals,
    onProposalApprove: (id: string) => void dream.onProposalDecision(id, "approved"),
    onProposalDismiss: (id: string) => void dream.onProposalDecision(id, "dismissed"),
    sounds: s.sounds,
