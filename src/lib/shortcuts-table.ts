...
export const DEFAULT_SHORTCUTS: ShortcutRow[] = [
  ...
  { id: "hub", action: "shortcut.hub", defaultBinding: "Mod+J" },
  { id: "focus-composer", action: "shortcut.focusComposer", defaultBinding: "Mod+L" },
  { id: "review", action: "shortcut.review", defaultBinding: "Mod+E" },
